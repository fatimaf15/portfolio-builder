...
import { Terminal, User, Mail, Lock, Eye, EyeOff, ArrowRight, Sparkles } from 'lucide-react';
    ...
    <div className="min-h-screen bg-zinc-950 flex flex-col justify-center items-center px-4 py-12 relative overflow-hidden text-white selection:bg-indigo-500 selection:text-white">
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-zinc-400 text-sm mt-2">Get started and publish your technical portfolios</p>
        </div>
        ...
        <div className="bg-zinc-900/40 border border-zinc-800/80 rounded-2xl p-8 backdrop-blur-md shadow-2xl">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="johndoe"
                  className="w-full pl-11 pr-4 py-3 bg-zinc-950 border border-zinc-800 focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/20 rounded-xl text-sm font-medium outline-none transition-all placeholder:text-zinc-650"
                  disabled={loading}
                />
              </div>
            </div>
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-11 pr-12 py-3 bg-zinc-950 border border-zinc-800 focus:border-indigo-500/50 focus:ring-1 focus:ring-indigo-500/20 rounded-xl text-sm font-medium outline-none transition-all placeholder:text-zinc-650"
                  disabled={loading}
                />
                <button
                  type="button"
            ...
            <motion.button
              ...
              type="submit"
              className="w-full inline-flex items-center justify-center gap-2 px-6 py-3.5 bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-500 hover:to-violet-500 text-sm font-bold text-white shadow-[0_0_20px_rgba(99,102,241,0.2)] rounded-xl transition-all cursor-pointer border border-indigo-400/10 disabled:opacity-55 disabled:cursor-not-allowed pt-2"
              disabled={loading}
            >
              {loading ? (
